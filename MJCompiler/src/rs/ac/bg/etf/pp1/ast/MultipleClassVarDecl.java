...
public class MultipleClassVarDecl extends ClassVarDecl {

    private ClassVarDecl ClassVarDecl;
    private VarDecl VarDecl;

    public MultipleClassVarDecl (ClassVarDecl ClassVarDecl, VarDecl VarDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MultipleClassVarDecl(\n");
